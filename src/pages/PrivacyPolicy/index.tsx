    ...
    <>
      ...
      <Container>
        ...
        <div>
          ...
          <ul>
            ...
            <li style={{ marginTop: "20px" }}>
              ...
              "Our" in this Agreement) refers to Loan Store.
            </li>
            <li style={{ marginTop: "20px" }}>
            ...
            <li style={{ marginTop: "20px" }}>
              <b>Website </b>refers to Loan Store, accessible from
              <a href="https://loanstore.online/">https://loanstore.online/</a>
            </li>
            <li style={{ marginTop: "20px" }}>
        ...
        <div>
          ...
          <ul>
            <li style={{ marginTop: "20px" }}>Email address</li>
            <li style={{ marginTop: "20px" }}>First name and last name</li>
            <li style={{ marginTop: "20px" }}>Phone number</li>
            <li style={{ marginTop: "20px" }}>Usage Data</li>
          </ul>
          <Typography
            variant="h5"
            style={{
          ...
          <ul>
            <div>
              ...
              <div style={{ marginBottom: "20px" }}>Type: Session Cookies</div>
              <div style={{ marginBottom: "20px" }}>Administered by: Us</div>
          ...
          <div>
            ...
            <ul>
              <li>By email: support@loanstore.com</li>
            </ul>
          </div>
        </div>
      </Container>
